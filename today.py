...
USER_NAME = os.environ['USER_NAME'] # matkumatmat
...
if __name__ == '__main__':
    ...
    # Uptime = GitHub join -> now (matkumatmat joined 2023-11-11)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2023, 11, 11))
